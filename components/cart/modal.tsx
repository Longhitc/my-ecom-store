...
export default function CartModal() {
  ...
  return (
    <>
      {/* Nút bấm Icon giỏ hàng trên Navbar */}
      <button 
      ...
      >
        ...
        {totalCount > 0 && (
          <div className="absolute right-0 top-0 -mr-2 -mt-2 h-4 w-4 rounded bg-blue-600 text-[10px] font-medium text-white flex items-center justify-center">
            {totalCount}
          </div>
        )}
      </button>

      {/* Cửa sổ giỏ hàng trượt ra */}
      <CartDrawer />
    </>
  );
}
